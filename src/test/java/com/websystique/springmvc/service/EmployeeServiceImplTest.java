...
public class EmployeeServiceImplTest {
	...
	@Test(expectedExceptions = EmployeeNotFoundException.class)
	public void updateEmployeeWhenMissingThrows() {
		Employee emp = employees.get(0);
		when(dao.findById(anyInt())).thenReturn(null);
		employeeService.updateEmployee(emp);
	}
	...
	public void deleteEmployeeBySsn() {
		...
		employeeService.deleteEmployeeBySsn("XXX111");
	...
	public void findEmployeeBySsn() {
		...
		Assert.assertEquals(employeeService.findEmployeeBySsn(emp.getSsn()), emp);
	}
